                        ...
                        <tbody>
                            <?php
                                if ($role=='admin'){
                                    ...
                                    $query = mysqli_query($link, "SELECT * FROM experiments where status='pending' AND eao LIKE '%$fullname%'");
                                }elseif ($role=='student'){
                                    $query = mysqli_query($link, "SELECT * FROM experiments where status='pending' AND student='$user'");
                                }
